parameters = [
  ...
  { name = "prod.user.redis_host", value = "elasticache-prod-elasticache-001.orwuei.0001.use1.cache.amazonaws.com" },
  { name = "prod.user.mongo_endpoint", value = "mongodb-prod.rdevopsb72.store" },
  { name = "prod.cart.redis_host", value = "elasticache-prod-elasticache-001.orwuei.0001.use1.cache.amazonaws.com" },
