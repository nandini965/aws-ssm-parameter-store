parameters = [
  ...
  { name = "prod.docdb.db_endpoint", value = "prod-docdb.cluster-csjjrrbf31kc.us-east-1.docdb.amazonaws.com" }
]
...
passwords = [
  ...
  { name = "prod.catalogue.mongo_url", value = "mongodb://roboshop:roboshop123456@prod-docdb.cluster-csjjrrbf31kc.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" },
  { name = "prod.user.mongo_url", value = "mongodb://roboshop:roboshop123456@prod-docdb.cluster-csjjrrbf31kc.us-east-1.docdb.amazonaws.com:27017/user?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" }
